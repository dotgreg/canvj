...
export let goToCompo = (nb) => {
  ...
  switch (nb) {
    case 1:
      ...
      // TIER man + flower + ink
      // mask(addV('ink4.mp4', {o:0.7, bw: false}), addS('tier1', {s: 50, c:'000'}))
      // mask(addV('eyeman1.mp4', {o:0.4, bw: false}), addS('tier2', {s: 50, c:'000'}))
      // mask(addV('floweropening2.mp4', {o:0.7, bw: false}), addS('tier3', {s: 50, c:'000'}))
